...
def getLotsOfWeibos():
    ...
    for j in range(1,pages+1):
        ...
        #for temp in dataSeta:         
            ...
            #temp = 'iG 3:1战胜VG！恭喜iG！http:///www.aa.com'
            print('昵称：'+name)
            print('微博：'+temp)
            sleep(2)
            temp = textParse(temp)
...
listOfTerms = mineWeibos(getLotsOfWeibos(),10)
#print(len(listOfTerms))
printResult(listOfTerms)
